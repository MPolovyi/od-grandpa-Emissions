...
c     6 *0.6*0.02*0.00278)))
       ...
       CHBIO(j)=DBIO(j)*(exp(-rmt1(j)*rmW1(j)*rmpH1(j)*0.6*
     5 0.66*0.00278))*(1-(0.85/(1+rE(j))))
        if(hgr(j) < -20)CHBIO(j)=0


       CHHUM(j)=DHUM(j)*(exp(-rmt1(j)*rmW1(j)*rmpH1(j)
...
c       R1CO2(j)=RPM(j)*(1-((1/ratX(j))))
      ...
      CHBIO1(j)=BIO1(j)*(exp(-rmt1(j)*rmW1(j)
     6 *rmpH1(j)*0.6*0.66*0.00278))*(1-(0.85/(1+rE(j))))
        if(hgr(j) < -20)CHBIO1(j)=0

      CHHUM1(j)=HUM1(j)*(exp(-rmt1(j)*rmW1(j)*rmpH1(j)
     6 *0.6*0.02*0.00278))*(1-0.85*(0.85/(1+rE(j))))
...
c     6 *0.6*0.02*0.08333)))
      ...
      CHBIO2(j)=BIO2(j)*(exp(-rmt1(j)*rmW1(j)
     6 *rmpH1(j)*0.6*0.66*0.00278))*(1-(0.85/(1+rE(j))))
        if(hgr(j) < -20)CHBIO2(j)=0

      CHHUM2(j)=HUM2(j)*(exp(-rmt1(j)*rmW1(j)*rmpH1(j)
     6 *0.6*0.02*0.00278))*(1-0.85*(0.85/(1+rE(j))))
...
c     6 *0.6*0.02*0.08333)))
      ...
      CHBIO3(j)=BIO3(j)*(exp(-raC(j)*rmW(j)
     6 *rmpH(j)*0.6*0.66*0.00278))*(1-(0.85/(1+rE(j))))
        if(hgr(j) < -20)CHBIO3(j)=0

      CHHUM3(j)=HUM3(j)*(exp(-raC(j)*rmW(j)*rmpH(j)
     6 *0.6*0.02*0.00278))*(1-0.85*(0.85/(1+rE(j))))
...
c     6 *0.6*0.02*0.08333)))
      ...
      PCHBIO(j)=PrDBIO(j)*(exp(-rmt1(j)*rmW1(j)
     6 *rmpH1(j)*0.6*0.66*0.00278))*(1-(0.85/(1+rE(j))))
        if(hgr(j) < -20)PCHBIO(j)=0

      PCHHUM(j)=PrDHUM(j)*(exp(-rmt1(j)*rmW1(j)*rmpH1(j)
     6 *0.6*0.02*0.00278))*(1-0.85*(0.85/(1+rE(j))))
...
c     6 *0.6*0.02*0.08333)))
       ...
       PCHB1(j)=PrBIO1(j)*(exp(-rmt1(j)*rmW1(j)
     6 *rmpH1(j)*0.6*0.66*0.00278))*(1-(0.85/(1+rE(j))))
        if(hgr(j) < -20)PCHB1(j)=0

       PCHH1(j)=PrHUM1(j)*(exp(-rmt1(j)*rmW1(j)*rmpH1(j)
     6 *0.6*0.02*0.00278))*(1-0.85*(0.85/(1+rE(j))))
...
c     6 *0.6*0.02*0.08333)))
       ...
       PCHB2(j)=PrBIO2(j)*(exp(-rmt1(j)*rmW1(j)
     6 *rmpH1(j)*0.6*0.66*0.00278))*(1-(0.85/(1+rE(j))))
        if(hgr(j) < -20)PCHB2(j)=0

       PCHH2(j)=PrHUM2(j)*(exp(-rmt1(j)*rmW1(j)*rmpH1(j)
     6 *0.6*0.02*0.00278))*(1-0.85*(0.85/(1+rE(j))))
...
c     6 *0.6*0.02*0.08333)))
       ...
       PCHB3(j)=PrBIO3(j)*(exp(-rmt1(j)*rmW1(j)
     6 *rmpH1(j)*0.6*0.66*0.00278))*(1-(0.85/(1+rE(j))))
        if(hgr(j) < -20)PCHB3(j)=0

       PCHH3(j)=PrHUM3(j)*(exp(-rmt1(j)*rmW1(j)*rmpH1(j)
     6 *0.6*0.02*0.00278))*(1-0.85*(0.85/(1+rE(j))))
...
c     6 *0.6*0.02*0.08333)))
      ...
      HSBIO0(j)=SBIO0(j)*(exp(-rmt1(j)*rmW1(j)
     6 *rmpH1(j)*0.6*0.66*0.00278))*(1-(0.85/(1+rE(j))))
        if(hgr(j) < -20)HSBIO0(j)=0

      HHUM00(j)=SHUM0(j)*(exp(-rmt1(j)*rmW1(j)*rmpH1(j)
     6 *0.6*0.02*0.00278))*(1-0.85*(0.85/(1+rE(j))))
...
c     6 *0.6*0.02*0.08333)))
      ...
      HSBIO(j)=SDBIO(j)*(exp(-rmt1(j)*rmW1(j)
     6 *rmpH1(j)*0.6*0.66*0.00278))*(1-(0.85/(1+rE(j))))
        if(hgr(j) < -20)HSBIO(j)=0

       HHUM0(j)=SDHUM(j)*(exp(-rmt1(j)*rmW1(j)*rmpH1(j)
     6 *0.6*0.02*0.00278))*(1-0.85*(0.85/(1+rE(j))))
...
c     6 *0.6*0.02*0.08333)))
      ...
      HSBIO1(j)=SBIO1(j)*(exp(-rmt1(j)*rmW1(j)
     6 *rmpH1(j)*0.6*0.66*0.00278))*(1-(0.85/(1+rE(j))))
        if(hgr(j) < -20)HSBIO1(j)=0

       HHUM1(j)=SHUM1(j)*(exp(-rmt1(j)*rmW1(j)*rmpH1(j)
     6 *0.6*0.02*0.00278))*(1-0.85*(0.85/(1+rE(j))))
...
c     6 *0.6*0.02*0.08333)))
      ...
      HSBIO2(j)=SBIO2(j)*(exp(-rmt1(j)*rmW1(j)
     6 *rmpH1(j)*0.6*0.66*0.00278))*(1-(0.85/(1+rE(j))))
        if(hgr(j) < -20)HSBIO2(j)=0

       HHUM2(j)=SHUM2(j)*(exp(-rmt1(j)*rmW1(j)*rmpH1(j)
     6 *0.6*0.02*0.00278))*(1-0.85*(0.85/(1+rE(j))))
...
c     6 *0.6*0.02*0.08333)))
      ...
      HSBIO3(j)=SBIO3(j)*(exp(-rmt1(j)*rmW1(j)
     6 *rmpH1(j)*0.6*0.66*0.00278))*(1-(0.85/(1+rE(j))))
        if(hgr(j) < -20)HSBIO3(j)=0

       HHUM3(j)=SHUM3(j)*(exp(-rmt1(j)*rmW1(j)*rmpH1(j)
     6 *0.6*0.02*0.00278))*(1-0.85*(0.85/(1+rE(j))))
...
c============================================================
	FDBIO(j)=FDPM(j)*(1/(1+ratX(j)))*0.46
      ...
      CHFBI0(j)=FDBIO(j)*(exp(-rmt1(j)*rmW1(j)
     6 *rmpH1(j)*0.6*0.66*0.00278))*(1-(0.85/(1+rE(j))))
        if(hgr(j) < -20)CHFBI0(j)=0

      CHFHU0(j)=FDHUM(j)*(exp(-rmt1(j)*rmW1(j)*rmpH1(j)
     6 *0.6*0.02*0.00278))*(1-0.85*(0.85/(1+rE(j))))
...
c============================================================
	FBIO1(j)=FRPM(j)*(1/(1+ratX(j)))*0.46
      ...
      CHFBI1(j)=FBIO1(j)*(exp(-rmt1(j)*rmW1(j)
     6 *rmpH1(j)*0.6*0.66*0.00278))*(1-(0.85/(1+rE(j))))
        if(hgr(j) < -20)CHFBI1(j)=0

      CHFHU1(j)=FHUM1(j)*(exp(-rmt1(j)*rmW1(j)*rmpH1(j)
     6 *0.6*0.02*0.00278))*(1-0.85*(0.85/(1+rE(j))))
...
c============================================================
	FBIO3(j)=FHUM(j)*(1/(1+ratX(j)))*0.46
      ...
      CHFBI3(j)=FBIO3(j)*(exp(-rmt1(j)*rmW1(j)
     6 *rmpH1(j)*0.6*0.66*0.00278))*(1-(0.85/(1+rE(j))))
        if(hgr(j) < -20)CHFBI3(j)=0

      CHFHU3(j)=FHUM3(j)*(exp(-rmt1(j)*rmW1(j)*rmpH1(j)
     6 *0.6*0.02*0.00278))*(1-0.85*(0.85/(1+rE(j))))
